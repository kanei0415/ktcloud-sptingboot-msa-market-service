...
class SecurityConfig(
            ...
            .authorizeExchange { exchange ->
                exchange
                    ...
                    .pathMatchers(
                        ...
                        "/admin/api/v1/auth/check",
                    ).permitAll()
                    .anyExchange().hasAuthority(adminSecurityProperties.requiredRole)
            }
    ...
    fun corsConfigurationSource(): CorsConfigurationSource {
        ...
        configuration.allowedOrigins = listOf("http://localhost:5174", "http://127.0.0.1:5174")
